...
class Video
{
    ...
    public function getEpisodNumber()
    {
    ...
    public function getNextEpisodeNum()
    {
        if ($this->isMovie()) {
            return;
        }
        ...
        $episode = $this->getEpisodNumber();

        return "Season $season, Episod $episode";
    }
    ...
    {
        $query = $this->conn->prepare("SELECT * FROM videoProgress WHERE videoId =:videoId AND username =:username");
